...
<script language="javascript" type="text/javascript">
    ...
    function Reload() {
        ...
        var newwindow = window.open(url + '&custom=' + document.getElementById('custom').value + '&tid=' + document.getElementById('id').value + '&value=0_' + name + '&rand=' + new Date().getTime(), 'name', 'height=700,width=800,scrollbars=yes,location=no');
                ...
                <div class="row">
             		<div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            ?>
                                <a href="#"
                                onclick="return popitup2('config.php?type=tool&display=epm_config&amp;quietmode=1&amp;handler=file&amp;file=popup.html.php&amp;module=endpointman&amp;pop_type=alt_cfg_edit', this.querySelector('code').textContent)"
                                class="file-link">
                                    <code class="template-label" id="code_<?php echo $row['idrefbox']; ?>"><?php echo $row['name']; ?></code>
                                    &nbsp;<i class='icon-pencil blue' ALT='<?php echo _(' Edit') ?>'></i>
                                </a>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group input-group-br files_edit_configs" name="boxselect_<?php echo $row['idrefbox']; ?>" id="boxselect_<?php echo $row['idrefbox']; ?>">
                                        <select class="form-control selectpicker show-tick"
                                                ...
                                                onchange="updateCodeContent(this, '<?php echo $row['idrefbox']; ?>')">
                                        </select>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                            ...
                            <script>
                                function updateCodeContent(selectElement, idrefbox) {
                                    var selectedName = selectElement.options[selectElement.selectedIndex].text;
                                    document.querySelector("#code_" + idrefbox).textContent = selectedName;
                                }
                            </script>
